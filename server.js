...
// User Schema (Authentication System)
...
// Routes for serving HTML pages (Authentication)
app.get("/", (req, res) => {
...
// Routes for Interview Functionality
app.get("/interview", (req, res) => {
    res.sendFile(path.join(__dirname, "interview.html")); // Serve interview page
});

// Set up multer to handle file uploads for interviews
...
// Save recording endpoint for interview
